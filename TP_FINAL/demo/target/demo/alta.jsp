			...
			<div class="container">
				<section>
					...
					<form method="post"
						...
						<div class="mb-3">
							<label for="exampleFormControlInput1" class="form-label">Fabricante</label>
							<input name="fabricante"  type="text" class="form-control" id="exampleFormControlInput1" placeholder="Fabricante" maxlength="50">
						  </div>
